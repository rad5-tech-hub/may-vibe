      ...
      <div className="bg-gray-200 rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div className="px-8 pt-8 pb-6">
          <div className="flex flex-col lg:flex-row gap-3 items-start justify-between mb-6">
            <div>
              <h2 className="text-xl font-bold text-gray-900">Royalties</h2>
              <p className="text-xs text-gray-500 mt-1">
                Track the money you make from the music you release.
              </p>
            </div>
            <button className="px-2 py-1 bg-white border border-orange-300 text-orange-600 rounded-md text-xs font-medium hover:bg-orange-50 transition-colors">
              Payment History
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-xl font-bold text-gray-900 mt-1">$24,092.75</p>
              <span className="inline-flex items-center gap-2 mt-2 px-3 py-1 bg-white text-orange-700 text-xs font-semibold rounded-full">
                Paid
              </span>
            </div>

            <div>
              <p className="text-xs text-gray-500">Next Payment (estimated)</p>
              <p className="text-xl font-bold text-gray-900 mt-1">$28,430.59</p>
              <p className="text-xs text-gray-400 mt-2">
                Payment to be made on: <span className="font-medium text-gray-700">23/09/2025</span>
              </p>
            </div>

            <div className="flex items-center justify-start md:justify-end gap-3 text-xs text-gray-500">
              <Sun className="w-5 h-5 text-orange-500" />
              <span className="bg-gray-100 px-3 py-1.5 rounded-lg font-medium text-gray-700">
                Payments Made To: juniorachebe@gmail.com
              </span>
            </div>
          </div>

          <div className="h-px bg-orange-500 to-transparent mt-8" />
        </div>
